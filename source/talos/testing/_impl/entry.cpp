...
$_NORETURN void Talos::Testing::Entry::m_execute() {
...
bool Talos::Testing::Entry::m_report(Diagnostic::Reporter *reporter, size_t sources) {
...
void Talos::Testing::Entry::m_unhandled($::Map::Base<$::URI::View, Value::Any> &&errors) {
...
void Talos::Testing::Entry::m_unhandled(const $::URI::View &resource, const Value::Any &reason) {
...
Talos::Testing::Entry::m_import(const $::URI::Buffer &resource, Diagnostic::Reporter *reporter) {
